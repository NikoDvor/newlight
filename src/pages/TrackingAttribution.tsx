...
const metrics = [
  { label: "Attributed Revenue", value: "—", change: "Activating", changeType: "neutral" as const },
  { label: "Conversion Rate", value: "—", change: "Activating", changeType: "neutral" as const },
  { label: "Cost Per Lead", value: "—", change: "Activating", changeType: "neutral" as const },
  { label: "ROI", value: "—", change: "Activating", changeType: "neutral" as const },
];
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      >
        ...
        <div>
          <h2 className="text-xl font-semibold text-foreground">Attribution Engine</h2>
          <p className="text-sm text-muted-foreground mt-2 max-w-md">
            Multi-touch attribution is being configured. Soon you’ll see exactly which channels are driving revenue.
          </p>
        </div>
